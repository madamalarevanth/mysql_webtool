...
<%
      ...
      %>
		...
		<br><br>
		  <form class="form-horizontal" action="droptable.jsp">
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-sm-5">
                 		<select class="form-control" name="tablename" id="sel1">
				      <%while(res.next()){ %>
		    ...
		    <div class="form-group">
		      <label class="control-label col-sm-offset-5 col-sm-2" for="email"></label>
		      	<div class="col-sm-5">
					<h4>Warning!! The Table once deleted can not be recovered again.</h4>		      
				</div>
		    </div>
		    ...
		    <div class="form-group">        
		      <div class="col-sm-offset-8 col-sm-3">
		        <button type="submit" class="btn btn-lg btn-primary">Drop Table</button>
		      </div>
		    </div>
		  </form>
	</div>
